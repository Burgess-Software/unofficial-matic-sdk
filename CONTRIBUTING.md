...
- Never invent protobuf tags to make an API look complete; fail closed.
- Never add real credentials, captures, maps, media, APKs, or native libraries.
- Keep device-changing hardware tests interactive and opt-in.
